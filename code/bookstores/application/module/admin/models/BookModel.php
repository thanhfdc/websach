...
class BookModel extends Model{
	...
	private $_columns = array('id', 'name', 'description', 'price','quantity', 'sale_off', 'picture','created', 'created_by', 'modified', 'modified_by', 'status', 'ordering', 'category_id');
	private $_userInfo;
	...
	public function listItem($arrParam, $option = null){
		$query[]	= "SELECT `b`.`id`, `b`.`special`, `b`.`name`, `b`.`picture`, `b`.`price`, `b`.`sale_off`, `b`.`quantity`, `b`.`status`, `b`.`ordering`, `b`.`created`, `b`.`created_by`, `b`.`modified`, `b`.`modified_by`, `c`.`name` AS `category_name`";
	...
	public function infoItem($arrParam, $option = null){
		if($option == null){
			$query[]	= "SELECT `id`, `description`, `picture`,`quantity`, `name`, `price`, `special`, `sale_off`, `category_id`, `status`, `ordering`";
			$query[]	= "FROM `$this->table`";
