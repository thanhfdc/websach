<?php
	...
	// Input
	$inputSubmit	= Helper::cmsInput('submit', 'form[submit]', 'submit', 'Đăng nhập', 'register');
	$inputToken		= Helper::cmsInput('hidden', 'form[token]', 'token', time()); 
	
	// Row
	$rowPassword	= Helper::cmsRow('Mật khẩu', Helper::cmsInput('password', 'form[password]', 'password', null, 'contact_input'));
